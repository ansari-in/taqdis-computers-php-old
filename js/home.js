...
function showcourseq(){
    document.getElementsByClassName("taqdisocmputerscoursesrt_uhsdf0")[0].style.height="auto";
    document.getElementsByClassName("showfulldivsadf_uhas")[2].style.display="none";
    document.getElementsByClassName("showlessservi")[2].style.display="grid";
}
function showlessq(){
    document.getElementsByClassName("taqdisocmputerscoursesrt_uhsdf0")[0].style.height="250px";
    document.getElementsByClassName("showfulldivsadf_uhas")[2].style.display="grid";
    document.getElementsByClassName("showlessservi")[2].style.display="none";
}